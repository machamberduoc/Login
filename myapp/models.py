...
class CustomUserManager(BaseUserManager):
    def create_user(self, username, correo, contrasena, **extra_fields):
        if not correo:
    ...
    def create_superuser(self, username, correo, contrasena, **extra_fields):
        extra_fields.setdefault('is_staff', True)
        extra_fields.setdefault('is_superuser', True)
        return self.create_user(username, correo, contrasena, **extra_fields)
...
class Monitor(models.Model):
    ...
    diknamem = models.CharField(max_length=100)
